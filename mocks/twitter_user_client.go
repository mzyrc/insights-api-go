...
type MockTwitterUserClient struct {
	...
	MockGetUsers   func(userIdList []int64) ([]twitter.User, *http.Response, error)
}
...
func (m MockTwitterUserClient) GetUsers(userIdList []int64)([]twitter.User, *http.Response, error) {
